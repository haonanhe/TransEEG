...
import sys
sys.path.append('/home/scutbci/public/hhn/Trans_EEG/codes/EEG_Transformer')
...
class PatchEmbedding(nn.Module):
    def __init__(self, n_channels, emb_size):
        ...
        self.projection = nn.Sequential(
            ...
            nn.BatchNorm2d(2),
            nn.LeakyReLU(0.2),
            nn.Conv2d(2, emb_size, (n_channels, 5), stride=(1, 5)),
...
class ViT(nn.Sequential):
    def __init__(self, n_channels, emb_size=10, depth=3, n_classes=4, **kwargs):
        super().__init__(
            # channel_attention(),
            ResidualAdd(
                nn.Sequential(
...
model = ViT(n_channels=22, emb_size=10, depth=3, n_classes=4)
x = model(x)
print(x.size())
